      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-slate-950 text-white pt-24 pb-16">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Oil & Gas Industrial Operations" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-12">
          <div className="max-w-4xl space-y-6">
            ...
            >
              ...
              <span>SAP OIL & GAS S/4HANA & UPSTREAM PRA</span>
            </motion.div>
            ...
            >
              Intelligent Upstream, Midstream & Downstream <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-300 via-cyan-200 to-white">Hydrocarbon Excellence</span>
            </motion.h1>
            ...
            >
              Transform energy assets with integrated <strong className="text-white font-semibold">SAP S/4HANA Clean Core</strong>, automated <strong className="text-sky-300 font-semibold">Production Revenue Accounting (PRA)</strong>, real-time TSW midstream scheduling, predictive refinery asset integrity, and continuous emissions governance.
            </motion.p>
            ...
            >
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/15 text-xs font-medium text-slate-200 shadow-sm">
                ...
                <span>SAP PRA Volumetric Allocation</span>
              </span>
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/15 text-xs font-medium text-slate-200 shadow-sm">
                <CheckCircle2 className="w-3.5 h-3.5 text-cyan-400" />
                <span>TSW Marine & Pipeline Logistics</span>
              </span>
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/15 text-xs font-medium text-slate-200 shadow-sm">
                <CheckCircle2 className="w-3.5 h-3.5 text-sky-400" />
                <span>Predictive Refinery Turnarounds</span>
              </span>
            </motion.div>
            ...
            >
              <button
                type="button"
                onClick={() => onOpenContact('Oil & Gas Architecture Consultation')}
            ...
            {/* Enterprise Architectural Trust Ribbon (Qualitative Architectural Focus) */}
            <motion.div 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              ...
              <div className="p-3.5 rounded-xl bg-white/[0.06] backdrop-blur-md border border-white/10 hover:border-sky-400/40 hover:bg-white/[0.09] transition-all">
                <span className="block text-[10.5px] font-mono uppercase text-sky-300 font-bold mb-1">Upstream Accounting</span>
                <span className="block text-xs sm:text-sm font-semibold text-white">Automated PRA Allocation</span>
              </div>
              <div className="p-3.5 rounded-xl bg-white/[0.06] backdrop-blur-md border border-white/10 hover:border-sky-400/40 hover:bg-white/[0.09] transition-all">
                <span className="block text-[10.5px] font-mono uppercase text-sky-300 font-bold mb-1">Midstream Logistics</span>
                <span className="block text-xs sm:text-sm font-semibold text-white">Trader's & Scheduler's TSW</span>
              </div>
              <div className="p-3.5 rounded-xl bg-white/[0.06] backdrop-blur-md border border-white/10 hover:border-sky-400/40 hover:bg-white/[0.09] transition-all">
                <span className="block text-[10.5px] font-mono uppercase text-sky-300 font-bold mb-1">Downstream APM</span>
                <span className="block text-xs sm:text-sm font-semibold text-white">Predictive Turnarounds</span>
              </div>
            </motion.div>
