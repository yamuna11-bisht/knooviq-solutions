    ...
    <div className="min-h-screen bg-white text-slate-900 overflow-x-hidden selection:bg-[#0070C0] selection:text-white">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-slate-950 text-white pt-24 pb-16">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1542332213-9b5a5a3fad35?auto=format&fit=crop&w=2000&q=85" 
            alt="Energy Services Field Operations" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-12">
          <div className="max-w-4xl space-y-6">
            ...
            >
              ...
              <span>SAP S/4HANA FOR OILFIELD & ENERGY SERVICES (OFS)</span>
            </motion.div>
            ...
            >
              Intelligent Field Service Dispatch, <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-300 via-cyan-200 to-white">Rig Logistics & Downhole Tool Serialization</span>
            </motion.h1>
            ...
            >
              Transform oilfield services and energy contracting with integrated <strong className="text-white font-semibold">SAP S/4HANA Clean Core</strong>, mobile wellsite electronic ticketing (e-Ticketing), heavy rig move logistics, serialized downhole tool tracking, and contractor safety governance.
            </motion.p>
            ...
            >
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/15 text-xs font-medium text-slate-200 shadow-sm">
                ...
                <span>Mobile Wellsite e-Ticketing</span>
              </span>
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/15 text-xs font-medium text-slate-200 shadow-sm">
                <CheckCircle2 className="w-3.5 h-3.5 text-cyan-400" />
                <span>Rig Move Heavy Haul Logistics</span>
              </span>
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/15 text-xs font-medium text-slate-200 shadow-sm">
                <CheckCircle2 className="w-3.5 h-3.5 text-sky-400" />
                <span>Downhole Tool Serialization & RUL</span>
              </span>
            </motion.div>
            ...
            >
              ...
              <div className="p-3.5 rounded-xl bg-white/[0.06] backdrop-blur-md border border-white/10 hover:border-sky-400/40 hover:bg-white/[0.09] transition-all">
                <span className="block text-[10.5px] font-mono uppercase text-sky-300 font-bold mb-1">Field Execution</span>
                <span className="block text-xs sm:text-sm font-semibold text-white">Offline Mobile e-Ticketing</span>
              </div>
              <div className="p-3.5 rounded-xl bg-white/[0.06] backdrop-blur-md border border-white/10 hover:border-sky-400/40 hover:bg-white/[0.09] transition-all">
                <span className="block text-[10.5px] font-mono uppercase text-sky-300 font-bold mb-1">Downhole Assets</span>
                <span className="block text-xs sm:text-sm font-semibold text-white">Serialized Tool Telemetry</span>
              </div>
              <div className="p-3.5 rounded-xl bg-white/[0.06] backdrop-blur-md border border-white/10 hover:border-sky-400/40 hover:bg-white/[0.09] transition-all">
                <span className="block text-[10.5px] font-mono uppercase text-sky-300 font-bold mb-1">Offshore Logistics</span>
                <span className="block text-xs sm:text-sm font-semibold text-white">PSV Vessel Deck Planning</span>
              </div>
            </motion.div>
