...
interface AccountsPayableIntelligencePageProps {
  onOpenContact?: (service?: string) => void;
}

export const AccountsPayableIntelligencePage: React.FC<AccountsPayableIntelligencePageProps> = ({ onOpenContact }) => {
  useEffect(() => {
    document.title = 'Accounts Payable Intelligence | Enterprise AI Products';
  }, []);
  ...
  const challenges = [
    {
      ...
      description: 'Hours lost manually keying data from PDFs, paper, and emails into accounting systems.',
      impact: 'Drains team bandwidth & causes bottlenecks',
      icon: Clock,
      tag: 'Labor Intensive'
    },
    {
      title: 'Data Entry Errors',
      description: 'Typos, mismatched line items, and missing tax codes trigger costly payment disputes.',
      impact: 'Recurrent mismatches and invoice disputes',
      icon: AlertCircle,
      tag: 'Financial Risk'
    },
    {
      title: 'Slow Approvals',
      description: 'Invoices trapped in email chains lead to delayed cycles and missed early-pay discounts.',
      impact: 'Protracted approval cycles and lost discounts',
      icon: Workflow,
      tag: 'Process Lag'
    },
    {
      title: 'Limited Visibility',
      description: 'Opaque liabilities and missing audit trails obscure real-time cash flow forecasting.',
      impact: 'Blind spots in cash management',
      icon: Eye,
      tag: 'Audit Friction'
    }
  ];
  ...
  const workflowSteps = [
    {
      ...
      desc: 'Instantly ingest invoices via email, supplier portals, SFTP, EDI, or mobile capture without manual sorting.',
      icon: Inbox,
    ...
    },
    {
      ...
      name: 'Extract',
      title: 'AI Neural Extraction',
      desc: 'Cognitive vision extracts headers, vendor tax IDs, complex multi-page line items, and currencies in real time.',
      icon: Cpu,
      badge: 'Deep Neural OCR'
    },
    {
      step: 3,
      ...
      desc: 'Autonomous cross-referencing against Purchase Orders, Goods Receipt Notes (GRN), and vendor master catalogs.',
      icon: ShieldCheck,
      badge: 'Autonomous Verification'
    },
    {
      step: 4,
      phase: 'Phase: Settlement',
      name: 'Approve',
      title: 'Smart Approval & Sync',
      desc: 'Touchless straight-through posting to SAP S/4HANA or ERP, with dynamic exception routing for manager sign-off.',
      icon: Send,
      badge: 'Touchless Posting'
    }
  ];
  ...
  const capabilities = [
    {
      ...
      desc: 'Deep learning models accurately parse structured, semi-structured, and scanned invoices across dozens of global formats.',
      icon: FileText,
      tag: 'Layout-Agnostic AI'
    },
    {
      title: 'Intelligent Validation',
      desc: 'Real-time mathematical checksums, GST/VAT verification, duplicate invoice prevention, and vendor bank verification.',
      icon: CheckCircle2,
      tag: 'Automated Compliance'
    },
    {
      title: 'Automated Matching',
      desc: 'Rule-driven tolerance matching dynamically reconciles PO quantities, line-item unit prices, and receiving receipts.',
      icon: Zap,
      tag: '3-Way Reconciliation'
    },
    {
      title: 'Approval Automation',
      desc: 'Configurable multi-tier delegation matrices route non-PO invoices to designated department leaders with mobile sign-offs.',
      icon: Workflow,
      tag: 'Smart Routing'
    }
  ];
  ...
  const strategicAdvantages = [
    {
      icon: Zap,
      title: 'Touchless Invoice Posting',
      category: 'Autonomous Accounting',
      description: 'Eliminate manual data keying and route multi-page supplier invoices directly into ERP ledgers with zero delays.'
    },
    {
      icon: ShieldCheck,
      title: 'Autonomous 3-Way Match',
      category: 'Continuous Verification',
      description: 'Automatically cross-reference invoices against purchase orders and goods receipt notes with flawless mathematical auditing.'
    },
    {
      icon: Workflow,
      title: 'Accelerated Approvals',
      category: 'Process Optimization',
      description: 'Streamline multi-tier leadership sign-offs and capture early-payment discounts through intelligent routing.'
    },
    {
      icon: Cpu,
      title: 'Universal ERP Connectivity',
      category: 'Enterprise Integration',
      description: 'Native bidirectional synchronization with SAP S/4HANA, Oracle ERP Cloud, NetSuite, and Workday Financials.'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#050B17] text-slate-900 dark:text-slate-100 transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
            ...
            >
              ...
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-sky-50 dark:bg-sky-950/40 border-2 border-sky-200 dark:border-sky-800/80 text-xs text-[#0077B6] dark:text-cyan-300 font-semibold shadow-xs">
                ...
                <span className="font-semibold text-slate-900 dark:text-white font-sans">Accounts Payable Intelligence</span>
                <span className="text-slate-300 dark:text-slate-600">|</span>
                <span className="text-[#0077B6] dark:text-cyan-400 font-semibold font-sans">Autonomous Invoicing Engine</span>
              </div>
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-slate-900 dark:text-white leading-[1.18] font-display">
                Zero-Touch Invoice Ingestion From{' '}
                ...
                to Automated General Ledger.
              </h1>

              {/* Subheading */}
              <p className="text-base sm:text-lg text-slate-600 dark:text-slate-300 leading-relaxed font-normal max-w-2xl font-sans">
                Eliminate manual keying, duplicate invoices, and lengthy reconciliation cycles. KnoovIQ extracts line items from complex multi-page invoices, performs autonomous 3-way matching, and posts verified accounting entries directly to SAP, Oracle, and NetSuite.
              </p>

              {/* Hero CTA Group */}
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 pt-2">
                <button
                  onClick={() => onOpenContact?.('Accounts Payable Intelligence')}
                ...
                >
                  <span>Request Live AP Demo</span>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-6 border-t-2 border-slate-300 dark:border-slate-700/80 text-left">
                <div className="group/item bg-white dark:bg-[#070E1C] p-3.5 rounded-xl border-2 border-slate-300 dark:border-slate-700 hover:border-[#00A3E0] dark:hover:border-[#00A3E0] transition-all duration-300 shadow-xs hover:shadow-md hover:-translate-y-0.5">
                  ...
                  <p className="text-[11px] text-[#0077B6] dark:text-cyan-400 font-medium mt-0.5 font-sans">Line-Item Parsing</p>
                </div>
                <div className="group/item bg-white dark:bg-[#070E1C] p-3.5 rounded-xl border-2 border-slate-300 dark:border-slate-700 hover:border-[#00A3E0] dark:hover:border-[#00A3E0] transition-all duration-300 shadow-xs hover:shadow-md hover:-translate-y-0.5">
                  ...
                  <p className="text-sm font-bold text-slate-900 dark:text-white mt-0.5 font-display">3-Way Match</p>
                  <p className="text-[11px] text-emerald-600 dark:text-emerald-400 font-medium mt-0.5 font-sans">PO &amp; GRN Reconciled</p>
                </div>
                <div className="group/item bg-white dark:bg-[#070E1C] p-3.5 rounded-xl border-2 border-slate-300 dark:border-slate-700 hover:border-[#00A3E0] dark:hover:border-[#00A3E0] transition-all duration-300 shadow-xs hover:shadow-md hover:-translate-y-0.5">
                  ...
                  <p className="text-sm font-bold text-slate-900 dark:text-white mt-0.5 font-display">Touchless</p>
                  <p className="text-[11px] text-[#0077B6] dark:text-cyan-400 font-medium mt-0.5 font-sans">Straight-Through</p>
                </div>
                <div className="group/item bg-white dark:bg-[#070E1C] p-3.5 rounded-xl border-2 border-slate-300 dark:border-slate-700 hover:border-[#00A3E0] dark:hover:border-[#00A3E0] transition-all duration-300 shadow-xs hover:shadow-md hover:-translate-y-0.5">
                  <div className="w-7 h-7 rounded-lg bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 flex items-center justify-center mb-2 group-hover/item:scale-110 transition-transform">
            ...
            >
              <div className="relative w-full rounded-2xl p-1 bg-gradient-to-b from-[#00A3E0]/30 via-cyan-500/15 to-blue-600/10 dark:from-[#00A3E0]/40 dark:via-white/10 dark:to-transparent shadow-2xl group">
                ...
                <div className="relative rounded-[14px] bg-[#070E1C] border-2 border-slate-300/40 dark:border-slate-700/80 overflow-hidden shadow-2xl h-[380px] sm:h-[460px] lg:h-[500px] xl:h-[540px]">
                  <img 
                    src="/images/accounts_payable_intelligence_hero.jpg" 
                    alt="Accounts Payable Intelligence - Autonomous 3-Way Invoice Matching" 
                  ...
                  <div className="absolute top-4 left-4 flex items-center gap-2">
                    <span className="px-3 py-1 rounded-full text-[10px] font-mono font-bold bg-[#070E1C]/90 backdrop-blur-md text-cyan-300 border-2 border-cyan-500/40 shadow-lg flex items-center gap-1.5">
                      ...
                      AUTONOMOUS AP RECONCILIATION ACTIVE
                    </span>
                  </div>
                  ...
                  <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between gap-2 p-3 rounded-xl bg-[#070E1C]/95 backdrop-blur-md border-2 border-slate-700 shadow-xl text-xs">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <div className="font-bold text-white text-[11px] font-sans">Autonomous 3-Way Match Verified</div>
                        <div className="text-[9px] text-slate-400 font-mono">Continuous Ledger Reconciliation Active</div>
                      </div>
                    </div>
      ...
      {/* =========================================================================
          2. AP CHALLENGES SECTION (4 Compact Cards With Darker Borders)
          ========================================================================= */}
      <section id="ap-friction" className="py-16 sm:py-24 bg-white dark:bg-[#070E1C] border-y-2 border-slate-300 dark:border-slate-800 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-14 space-y-3">
            ...
            <h2 className="font-display text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-slate-900 dark:text-white">
              From Manual Processing to Intelligent Accounts Payable
            </h2>
            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 font-sans max-w-2xl mx-auto leading-relaxed">
              Traditional finance workflows struggle under manual data entry, disconnected spreadsheets, and error-prone reconciliation.
            </p>
          </div>
      ...
      <section className="py-20 sm:py-28 bg-[#F8FAFC] dark:bg-[#050B17] border-y-2 border-slate-300 dark:border-slate-800 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
            <span className="text-xs font-mono font-bold uppercase tracking-widest text-[#00A3E0] dark:text-cyan-400">
              Autonomous Document Pipeline
            </span>
            <h2 className="font-display text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-slate-900 dark:text-white">
              Intelligent Invoice Processing
            </h2>
            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 font-sans max-w-2xl mx-auto leading-relaxed">
              Watch unstructured supplier invoices transform into validated ERP entries in four seamless stages.
            </p>
          </div>
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3 pb-4 border-b-2 border-slate-800 relative z-10">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="ml-2 text-[11px] font-mono font-bold text-slate-400">
                        knooviq-kernel://cognitive-runtime
                      </span>
                    </div>
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <span className="text-xs font-mono font-bold uppercase tracking-wider text-cyan-400 flex items-center gap-2">
                              <span className="w-2 h-2 rounded-full bg-cyan-400 animate-pulse" />
                              Omnichannel Ingestion Stream Active
                            </span>
                          ...
                          {/* Ingestion Channels Pipeline Cards */}
                          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            <div className="p-3.5 rounded-xl bg-white/5 border border-cyan-500/30 space-y-2">
                              ...
                              <div className="text-xs font-bold text-white font-display">AP Mailbox Intake</div>
                              <p className="text-[10px] text-slate-400 font-sans">Continuous background PDF &amp; scan listener</p>
                              <div className="text-[9px] font-mono text-cyan-300 bg-cyan-500/10 px-2 py-0.5 rounded w-fit">Direct Stream</div>
                            </div>
                            ...
                            <div className="p-3.5 rounded-xl bg-white/5 border border-purple-500/30 space-y-2">
                              ...
                              <div className="text-xs font-bold text-white font-display">Supplier EDI / Portals</div>
                              <p className="text-[10px] text-slate-400 font-sans">Structured XML, EDIFACT &amp; API webhooks</p>
                              <div className="text-[9px] font-mono text-purple-300 bg-purple-500/10 px-2 py-0.5 rounded w-fit">Automated Ingest</div>
                            </div>
                            ...
                            <div className="p-3.5 rounded-xl bg-white/5 border border-blue-500/30 space-y-2">
                              ...
                              <div className="text-xs font-bold text-white font-display">Secure SFTP &amp; Cloud</div>
                              <p className="text-[10px] text-slate-400 font-sans">Batch repository synchronization</p>
                              <div className="text-[9px] font-mono text-blue-300 bg-blue-500/10 px-2 py-0.5 rounded w-fit">Encrypted Storage</div>
                            </div>
                          </div>

                          {/* Live Intake Telemetry Bar */}
                          <div className="p-3 rounded-xl bg-cyan-500/10 border border-cyan-500/30 flex items-center justify-between text-xs">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-[11px] text-slate-300 font-sans">Zero Pre-Sorting or Manual File Splitting Required</span>
                            </div>
                      ...
                      {activeStep === 2 && (
                        ...
                        >
                          ...
                          <div className="relative p-4 rounded-xl bg-white/5 border-2 border-purple-500/40 overflow-hidden space-y-3">
                            ...
                            <div className="flex items-center justify-between p-2 rounded-lg bg-purple-500/10 border border-purple-500/30">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-[11px] text-white font-mono font-bold">Vendor Identification</span>
                              </div>
                              <span className="text-[10px] font-mono text-emerald-400 font-semibold">Matched &amp; Verified</span>
                            </div>
                            ...
                            <div className="flex items-center justify-between p-2 rounded-lg bg-cyan-500/10 border border-cyan-500/30">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-[11px] text-white font-mono font-bold">Line Items &amp; Nested Tables</span>
                              </div>
                              <span className="text-[10px] font-mono text-cyan-300 font-semibold">Structured Table Extracted</span>
                            </div>

                            <div className="flex items-center justify-between p-2 rounded-lg bg-emerald-500/10 border border-emerald-500/30">
                              <div className="flex items-center gap-2">
                                <CheckCheck className="h-3.5 w-3.5 text-emerald-400" />
                                <span className="text-[11px] text-white font-mono font-bold">Tax, Discounts &amp; Currencies</span>
                              </div>
                          ...
                          <div className="p-3 rounded-xl bg-purple-500/10 border border-purple-500/30 flex items-center justify-between text-xs">
                            <span className="text-[11px] text-slate-300 font-sans">Contextual deep learning understands shifted columns and handwritten remarks</span>
                        ...
                        >
                          ...
                          <div className="grid grid-cols-3 gap-2 text-center">
                            <div className="p-3 rounded-xl bg-white/5 border-2 border-emerald-500/40 space-y-1">
                              ...
                              <div className="text-[9px] text-slate-400 font-sans">Authorized terms</div>
                            </div>
                            <div className="p-3 rounded-xl bg-white/5 border-2 border-emerald-500/40 space-y-1">
                              <div className="text-[10px] font-mono text-emerald-400 font-bold uppercase">Record B</div>
                              <div className="text-xs font-bold text-white font-display">Goods Receipt</div>
                              <div className="text-[9px] text-slate-400 font-sans">Warehouse verified</div>
                            </div>
                            <div className="p-3 rounded-xl bg-white/5 border-2 border-emerald-500/40 space-y-1">
                              <div className="text-[10px] font-mono text-emerald-400 font-bold uppercase">Record C</div>
                              <div className="text-xs font-bold text-white font-display">Vendor Invoice</div>
                              <div className="text-[9px] text-slate-400 font-sans">Billed amounts</div>
                            </div>
                          </div>
                          ...
                          <div className="p-3.5 rounded-xl bg-white/5 border border-slate-700 space-y-2">
                            <div className="flex items-center justify-between text-xs">
                              <span className="text-slate-300 font-sans flex items-center gap-2">
                                ...
                                Unit Price &amp; Quantity Validation
                              </span>
                            ...
                            <div className="flex items-center justify-between text-xs">
                              <span className="text-slate-300 font-sans flex items-center gap-2">
                                <CheckCircle2 className="h-3.5 w-3.5 text-emerald-400" />
                                Anti-Duplicate &amp; Fraud Anomaly Detection
                              </span>
                            ...
                            <div className="flex items-center justify-between text-xs">
                              <span className="text-slate-300 font-sans flex items-center gap-2">
                                <CheckCircle2 className="h-3.5 w-3.5 text-emerald-400" />
                                Mathematical Line-Item Checksum
                              </span>
                        ...
                        >
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            <div className="p-3.5 rounded-xl bg-white/5 border border-blue-500/30 text-center space-y-1.5">
                              ...
                              <div className="text-xs font-bold text-white font-display">SAP S/4HANA</div>
                            ...
                            <div className="p-3.5 rounded-xl bg-white/5 border border-blue-500/30 text-center space-y-1.5">
                              ...
                              <div className="text-xs font-bold text-white font-display">Oracle Cloud ERP</div>
                              <span className="inline-block text-[9px] font-mono text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded">
                                Ledger Synced
                              </span>
                            </div>
                            ...
                            <div className="p-3.5 rounded-xl bg-white/5 border border-blue-500/30 text-center space-y-1.5">
                              ...
                              <div className="text-xs font-bold text-white font-display">Workday &amp; NetSuite</div>
                              <span className="inline-block text-[9px] font-mono text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded">
                                Payment Scheduled
                              </span>
                            </div>
                          ...
                          <div className="p-3 rounded-xl bg-blue-500/10 border border-blue-500/30 flex items-center justify-between text-xs">
                            <span className="text-[11px] text-slate-300 font-sans">Complete cryptographic audit trail preserved for tax and compliance authorities</span>
                  ...
                  <div className="pt-4 border-t-2 border-slate-800 flex items-center justify-between text-xs relative z-10">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[11px] text-slate-400 font-mono">
                        Pipeline Status: <span className="text-emerald-400 font-bold">Autonomous Execution Active</span>
                      </span>
                    </div>
      ...
      {/* =========================================================================
          4. KEY CAPABILITIES SECTION (4 Compact Cards With Darker Borders)
          ========================================================================= */}
      <section className="py-20 sm:py-24 bg-white dark:bg-[#070E1C] border-t-2 border-slate-300 dark:border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-14 space-y-3">
            ...
            <h2 className="font-display text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-slate-900 dark:text-white">
              Smarter Accounts Payable Operations
            </h2>
            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 font-sans max-w-2xl mx-auto leading-relaxed">
              Precision cognitive modules designed to handle the complexity of global supplier ecosystems.
            </p>
          </div>
      ...
      <section className="py-20 sm:py-24 bg-[#F8FAFC] dark:bg-[#050B17] border-t-2 border-slate-300 dark:border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-14 space-y-3">
            ...
            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 font-sans max-w-2xl mx-auto leading-relaxed">
              Delivering executive standard throughput and financial risk mitigation across accounts payable.
            </p>
          </div>
...
export default AccountsPayableIntelligencePage;
